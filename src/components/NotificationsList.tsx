  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      <div className="flex justify-between items-center bg-slate-900 p-8 rounded-[2.5rem] border border-slate-800 shadow-2xl">
        <div>
          <h2 className="text-4xl font-black text-white tracking-tighter uppercase mb-2 italic">Centro de <span className="text-indigo-400">Notificaciones</span></h2>
        ...
        <button 
          onClick={markAsRead}
          className="bg-indigo-600/10 text-indigo-400 border border-indigo-500/20 px-6 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-indigo-500/20 transition-all flex items-center gap-2"
        >
            ...
            notifications.map((notif: any, index: number) => (
              <motion.div 
                ...
                className={cn(
                  ...
                  !notif.read && "bg-indigo-500/5 border-l-4 border-l-indigo-500"
                )}
              >
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start mb-2">
                    <p className="text-lg font-bold text-white group-hover:text-indigo-400 transition-colors leading-snug">
                      {notif.content}
                    </p>
